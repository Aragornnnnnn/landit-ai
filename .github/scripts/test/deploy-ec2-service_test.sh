...
expected_command="ssm send-command --instance-ids i-123 --document-name develop-landit-ec2-deploy --parameters service=ai,imageSha=$SHA --query Command.CommandId --output text"
