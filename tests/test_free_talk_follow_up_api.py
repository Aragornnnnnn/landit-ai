...
class FollowUpRulesTests(unittest.TestCase):
    ...
    def test_scheduled_date_status_reads_calendar_dates_from_content(self):
        ...
        cases = {
            ...
            # 말한 날과 같은 날짜는 이미 끝난 일인지 저녁에 있을 일인지 날짜만으로 알 수 없다
            "사용자는 2026-09-01에 마라톤에서 우승했다": "UNKNOWN",
            "사용자는 2026-09-01 저녁에 면접이 있다": "UNKNOWN",
            "사용자는 2026-08-31에 마라톤에서 우승했다": "NOT_SCHEDULED",
