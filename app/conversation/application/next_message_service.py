...
def _inner_thought_system_prompt() -> str:
    return "\n\n".join([
        ...
        (
            ...
            "answerCoverage must be COMPLETE, PARTIAL, DECLINED, or UNRELATED. "
            "Use COMPLETE when the last utterance answers the core request, PARTIAL when a requested part is missing, DECLINED when the user will not or cannot answer, and UNRELATED when it does not answer the question. "
            "relationshipTone must be WARM, NEUTRAL, BLUNT, or HOSTILE. Judge how the last utterance feels to the counterpart in the full conversation context. "
            "directedAttack must be true only for profanity, insults, or threats aimed at the current counterpart; quoted speech or profanity about a situation is false. "
        ...
        (
            ...
            "answerCoverage must be COMPLETE, PARTIAL, DECLINED, or UNRELATED. "
            "relationshipTone must be WARM, NEUTRAL, BLUNT, or HOSTILE. "
            "directedAttack must be a JSON boolean. "
